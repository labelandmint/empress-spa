...
class TransactionController extends Controller
{
    public function index()
    {
        ...
        return view('admin.transactions.index', compact('subscriberCount', 'subscriptionValue', 'totalThisMonth', 'totalLastMonth', 'transactions'));
    }
    ...
    public function downloadInvoice(Request $request,$id)
    {
        ...
        $invoice = PDF::loadView('admin.transactions.invoice', compact('transaction','BankDetail'));
