...
<style>
    ...
    <div class="col-lg-9 es-py-8">
                ...
                <div class="card-body d-flex flex-column es-font-mulish es-px-6 es-pb-8">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            ...
                            <div class="{{$user->photo ? '': 'd-none'}}" id="file-preview-container">
                                <img src="{{url('images/' .$user->photo)}}" alt="Preview Uploaded Image" id="photo-preview" 
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 es-mt-6">
                            ...
                            <input id="last_name" name="last_name" type="text" class="form-control es-input mt-2" placeholder="Last Name"
                                value="{{ $user->l_name ?? '' }}" />
                            <div class="es-input-error-message"></div>
                        </div>
                        <div class="col-xl-4 es-mt-6">
                            <label for="address"> Address </label>
                            <input id="address" name="address" type="text" class="form-control es-input mt-2" placeholder="Address"
                                value="{{ $user->address ?? '' }}" />
                            <div class="es-input-error-message"></div>
                        </div>
                        <div class="col-xl-4 es-mt-6">
                        ...
                        <div class="col-xl-4 es-mt-6">
                            ...
                            <input id="phone_number" name="phone_number" type="text" class="form-control es-input mt-2"
                ...
                <div class="card-body d-flex flex-column es-font-mulish es-px-6 es-pb-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 es-mt-6 d-flex align-items-start">
                            ...
                            <a style="" href="{{ url('subscription/resume/'.$subscription->id) }}"  class="es-btn-outline es-w-full text-decoration-none es-h-auto" >
                                Resume Membership
                            </a>
                            @endif
                        </div>
        ...
        <form action="{{url('bank-detail/store')}}" method="POST">
            @csrf
            <div class="card border-0 es-mb-6">
                <div class="card-body d-flex flex-column es-font-mulish es-px-6 es-pb-8">
                    <div class="es-pb-6 es-pt-2 es-font-mulish-bold es-header-6">
                    ...
                    <div class="row">
                        <div class="col-xl-4 es-mt-6">
                            ...
                            <input id="name" name="cardholder_name" type="text" class="form-control es-input mt-2" placeholder="Name"
