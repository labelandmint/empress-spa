...
<div class="col-lg-9 es-py-8">
    ...
    <form action="{{url('admin/store')}}" enctype="multipart/form-data" method="post" id="page-design">
        ...
        <div class="card border-0 es-mb-6">
            <div
                class="card-body d-flex flex-column es-font-mulish es-px-6 es-pb-8"
            >
                    ...
                    <div class="card-footer">
                        <div class="form-check">
                            <input
                                ...
                                type="checkbox"
                                name="company_terms"
                                value="1"  {{ old('company_terms', $settings->company_terms ?? '') == 1 ? 'checked' : '' }}
                                id="flexCheckChecked"
                            />
                            <label
                                class="form-check-label es-text-sm es-font-mulish-bold"
                ...
                <div>
                    ...
                    <div class="mt-2">
                        ...
                        <div class="{{  $settings && $settings->logo ? '' : 'd-none' }}" id="file_preview_container_page_logo">
                            <img
                ...
                <div class="es-mt-6">
                    ...
                    <div class="mt-2">
                        ...
                        />
                        <label
                            for="photo_input_page_background"
                        ...
                        <div class="{{  $settings && $settings->page_background_image ? '' : 'd-none' }}" id="file_preview_container_page_background">
                            <img
                ...
                <div class="row">
                    <div class="col-lg-6 d-flex flex-column es-mt-6">
                        ...
                        <input
                            ...
                            class="form-control es-input mt-2"
                            placeholder="Ratio 1"
                            value="{{ old('ratio_1', $settings->ratio_1 ?? '') }}"
                        />
                        <div class="es-input-error-message"></div>
                    </div>
                    <div class="col-lg-6 d-flex flex-column es-mt-6">
                        ...
                        <input
                            ...
                            class="form-control es-input mt-2"
                            placeholder="Ratio 2"
                            value="{{ old('ratio_2', $settings->ratio_2 ?? '') }}"
                        />
                        <div class="es-input-error-message"></div>
                    </div>
                    <div class="col-lg-6 d-flex flex-column es-mt-6">
                ...
                <div id="stripeForm">
                    <div class="d-flex flex-column es-mt-6">
                        <label for="publishable_key"
                            >Live/Test Publishable Key</label
                        >
                        <input
                            id="publishable_key"
                            ...
                            type="text"
                            class="form-control es-input mt-2"
                            placeholder="Live/Test Publishable Key"
                    ...
                    <div class="d-flex flex-column es-mt-6">
                        ...
                        <input
                            ...
                            type="password"
                            class="form-control es-input mt-2"
                            placeholder="Live/Test Secret Key"
        ...
        <div class="card border-0 es-mb-6">
            ...
            >
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input
                            ...
                            accept=".jpg,.jpeg,.png"
                            hidden
                            id="photo_input_email_logo"
                            name="email_logo"

                        />
                        <label
                            for="photo_input_email_logo"
                        ...
                        <div class="{{$settings && $settings->email_logo ? '' : 'd-none'}}" id="file_preview_container_email_logo">
                            <img
                ...
                <div class="es-mt-6">
                    ...
                    <div class="mt-2">
                        <input
                            ...
                            accept=".jpg,.jpeg,.png"
                            hidden
                            id="photo_input_email_graphic"
                            name="email_background_image"
                        />
                        <label
                            for="photo_input_email_graphic"
                        ...
                        <div
                            class="{{$settings && $settings->email_background_image ? '' : 'd-none'}}"
                ...
                <div class="row">
                    <div class="d-flex flex-column col-lg-6 es-mt-6">
                        <div class="d-flex flex-column flex-lg-row gap-2">
                            ...
                            <button
                                ...
                                data-bs-target="#viewEmailTemplate"
                        ...
                        <input
                            id="successful_registration_subject"
                            name="successful_registration_subject"
                            type="text"
                            class="form-control es-input mt-2"
                            placeholder="Subject"
                    ...
                    <div
                        class="d-flex flex-column col-lg-6 es-mt-6 align-self-end"
                    >
                        <label for="successful_registration_body"></label>
                        <input
                            id="successful_registration_body"
                            name="successful_registration_body"
                            type="text"
                            class="form-control es-input mt-2"
                            placeholder="Body"
                ...
                <div class="row">
                    <div class="d-flex flex-column col-lg-6 es-mt-6">
                        ...
                        <input
                            id="successful_payment_subject"
                            name="successful_payment_subject"
                            type="text"
                            class="form-control es-input mt-2"
                            placeholder="Subject"
                    ...
                    >
                        ...
                        <input
                            id="successful_payment_body"
                            name="successful_payment_body"
                            type="text"
                            class="form-control es-input mt-2"
                            placeholder="Body"
    ...
    <div class="card border-0">
        <div class="card-body es-pb-8 es-px-0">
            ...
            <form action="{{ url('admin/add-user') }}" method="post" class="es-mb-6 es-px-6" id="user-management">
                @csrf
            ...
            <div class="es-table">
                <div
                    class="es-table-header d-flex align-items-center justify-content-between es-px-6"
                >
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a
                                            href="#viewEditUserModal"
                                            class="es-link-primary edit-user-record"
                                            data-bs-toggle="modal"
                                            role="button"
...
id="viewEmailTemplate"
tabindex="-1"
role="dialog"
aria-labelledby="viewEmailTemplateLabel"
aria-hidden="true"
>
...
<div class="modal-content">
    <div class="card">
        <div class="card-body es-px-6 es-pt-6 es-pb-10">
            <div
                class="d-flex align-items-center justify-content-between es-text-lg es-font-mulish-bold"
            >
            ...
            <div
                class="es-font-mulish-bold es-text-3xl text-center es-mb-8"
            >
...
class="modal fade"
data-bs-backdrop="static"
id="viewEditUserModal"
tabindex="-1"
role="dialog"
aria-labelledby="viewEditUserModalLabel"
aria-hidden="true"
>
            ...
            <form action="{{url('admin/add-user')}}" method="post" id="edit-user">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 es-mt-6 d-flex align-items-end">
                        <button
                            type="submit"
                            class="es-btn es-w-full es-h-auto"
                            data-bs-dismiss="modal"
                        >
                            Save
                        </button>
