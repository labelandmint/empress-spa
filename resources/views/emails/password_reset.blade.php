            ...
            <tr>
              <td align="left">
                <span
                  class="inner_txt"
                  style="font-size: 17.5px; color: #1d1b18"
                  >You are receiving this email because we received a password reset request for your account at Empress Spa.
                </span>
              </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="left">
                  <span
                    ...
                    >Click the link below to generate your new password
                  </span>
                  <p>
                    <a href="{{ $link }}" class="button"
                      >Generate New Password</a
                    >
                  </p>
                </td>
              </tr>
