...
<body>
                        ...
                        <tbody>
                            <tr>
                                <td width="100%" align="left" valign="top">
                                    <span style="color: #fad479; font-size: 11px; font-weight: 400">INVOICE
                                        TO</span><br /><span
                                        style="font-size: 20px; font-weight: bold; color: white">{{ $transaction->f_name . ' ' . $transaction->l_name }}</span>
                                </td>
                                <td width="50%" align="right" valign="top">
                                    <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/colored-empress-spa-logo.png'))) }}"
                                        alt="emp_logo" style="width: 310px" />
                                </td>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="35%" align="left" valign="top">
                                    <div class="parent">
                                        <div class="child1">
                                            <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/phone.png'))) }}"
                                                alt="phnicn" />
                                        </div>
                                        <div class="child2">
                                ...
                                <td width="30%" align="left" valign="top">
                                    <div class="parent">
                                        <div class="child1">
                                            <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/website.png'))) }}"
                                                alt="website" />
                                        </div>
                                        <div class="child2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="35%" align="left" valign="top">
                                    <div class="parent">
                                        <div class="child1">
                                            <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/email.png'))) }}"
                                                alt="email" />
                                        </div>
                                        <div class="child2">
                                ...
                                <td width="30%" align="left" valign="top">
                                    <div class="parent">
                                        <div class="child1">
                                            <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/address.png'))) }}"
                                                alt="address" style="margin-bottom:23px;"/>
                                        </div>
                                        <div class="child2">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    ">TAX
                            ...
                            <td width="50%" align="right" valign="top" style="padding-right:20px;">
                                <span
                                    style="color: #fad479; font-size: 11px; font-weight: 400">{{ $transaction->title }}</span><br /><span
                                    style="font-size: 20px; font-weight: bold; color: white">${{ number_format($transaction->amount, 2) }}</span>
                            </td>
                        </tr>
                        <tr>
    ...
    <div
      ...
      border-radius: 6px;
      padding: 20px 0;">
      <div><img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/squarelogo.png'))) }}" alt="" style="width:400px;position:absolute;top:30%;z-index:9999;left:26%;"></div>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                <tr>
                    <td align="center" valign="top">
                                ...
                                <tr style="padding: 0 10px">
                                    ...
                                    <td width="30%" align="left" valign="center">
                                        <div class="tab4"><span>{{ $transaction->title }}</span><br />
                                            <span style="font-size: 10px;">{{ $transaction->description }}</span>
                                        </div>
                                    </td>
                                    <td width="20%" align="center" valign="center">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                                <tr style="padding: 0 10px">
                                    <td width="53%" align="left" valign="center">
                                        <div class="tab4"
                                            style="padding-left:20px;padding-top:0px;padding-bottom:0px;">
                                            <span>&nbsp;</span></div>
                                    </td>
                                    <td width="47%" align="left" valign="center" style="padding-right:20px;">
                                        <div class="tab4"
                                            style="border-top:2px solid white;padding-top:0px;padding-bottom:0px;">
                                            <span>&nbsp;</span></div>
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <td align="center" valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                                <tr style="padding: 0 10px">
                                    <td width="53%" align="left" valign="center">
                                        <div class="tab4" style="padding-left:20px;padding-top:0px;"><span></span>
                                        </div>
                                    </td>
                                    <td width="32%" align="left" valign="center">
                    ...
                    <td align="center" valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                                <tr style="padding: 0 10px">
                                    <td width="53%" align="left" valign="center">
                                        <div class="tab4" style="padding-left:20px;padding-top:20px;"><span></span>
                                        </div>
                                    </td>
                                    <td width="32%" align="left" valign="center">
                                        <div class="tab4"
                                            style="padding:0px;border-radius: 9px;
                      color: black;
                      background-color: #fad479;
                      font-weight: bold;
                      padding: 3px 14px;border-top-right-radius:0px;border-bottom-right-radius:0px;">
                                            <spanm style="font-size:22px;">TOTAL</spanm>
                                        </div>
                                    </td>
    ...
    <table width="100%" style="margin-top: 5px;">
        <tr>
                ...
                <table style="color: white;">
                    ...
                    <tr>
                        ...
                        <td style="font-size: 13px;">:
                            {{ str_repeat('xxxx ', 3) }}{{ $BankDetail ? substr($BankDetail->card_no, -4) : '' }}</td>
                    </tr>

                    <tr>
                        <td style="padding-right: 20px;font-size:13px;">Account Name</td>
                        <td style="font-size:13px;">: {{ $BankDetail ? $BankDetail->cardholder_name : '' }}</td>
                    </tr>
                    <tr>
            ...
            <td width="50%" valign="top" style="padding: 20px; text-align: center;">
              ...
              /> -->
                <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/empress-spa-reception.png'))) }}"
                    style="width: 100%; object-fit: contain;height: 330px;" alt="Empress Spa Reception" />
            </td>
        </tr>
    </table>
</body>
