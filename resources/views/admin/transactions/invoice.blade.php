          ...
          <td width="50%" valign="top" style="padding: 20px; color: white;">
              ...
              <table style="color: white;">
                  <tr>
                      ...
                      <td style="font-size: 13px;">: @if($BankDetail){{ str_repeat('xxxx ', 3) }}{{ substr($BankDetail->card_no, -4) }}@endif</td>
                  </tr>
                  <tr>
                      <td style="padding-right: 20px;font-size:13px;">Account Name</td>
                      <td style="font-size:13px;">: @if($BankDetail){{$BankDetail->cardholder_name}}@endif</td>
                  </tr>
                  <tr>
                      <td style="padding-right: 20px;font-size:13px;">Billing Email</td>
                      <td style="font-size:13px;">: {{$transaction->email}}</td>
                  </tr>
              </table>
          </td>
