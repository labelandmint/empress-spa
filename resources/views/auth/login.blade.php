@php
    ...
    if (!preg_match('/^https?:\/\//', $fullUrl)) {
        $fullUrl = 'https://' . $fullUrl;
            ...
            $userCount = DB::table('users')->where('user_role', 2)
            ...
            <div class="row col-reverse position-relative">
                <div class="col-lg-6 es-pt-20 es-pb-24">
                    ...
                    <div class="es-mb-8">
                        ...
                        <div class="es-mb-5">
                            <input id="email" name="email" type="text" class="form-control es-input mt-2"
                        ...
                        <div class="es-mb-5 d-flex">
                            <input id="password" type="password" name="password" class="form-control es-input"
                        ...
                        @if ($errors->has('password'))
                            <div class="es-input-error-message">{{ $errors->first('password') }}</div>
                        @endif
                        <div class="d-flex align-items-center justify-content-end">
                            <a href="{{ url('password/forgot') }}"
                                class="text-decoration-none es-text-gray-900 es-mb-8"> Forgot Password? </a>
                        </div>
                    </div>
                    <div>
                        <button type="submit" class="es-btn w-100 es-mb-8">Login</button>
                        <!-- <div class="d-flex align-items-center justify-content-center">
        <div>Not a member yet?&nbsp;</div>
        <div>
         <a href="{{ url('register/null') }}" class="es-link-primary"> Register </a>
        </div>
       </div> -->
                    </div>
                </div>
