              ...
              >
                <tbody>
                  <tr style="padding: 0 10px">
                    ...
                    <td width="20%" align="center" valign="center">
                      <div class="tab3"><span>LAST NAME</span></div>
                    </td>
                    <td width="20%" align="center" valign="center">
                      <div class="tab3"><span>SUBSCRIPTION</span></div>
                    </td>
                    <td width="20%" align="center" valign="center">
                      <div class="tab3"><span>PRICE(ex. GST)</span></div>
                    </td>
                    <td width="20%" align="center" valign="center">
                      <div
                        class="tab3"
            ...
            <td align="center" valign="top">
              ...
              >
                <!-- <tbody>
                  <tr >
                    <td >
                      <div class="tab4"><span>[First Name]</span></div>
                    </td>
                    <td width="20%" align="center" valign="center">
                      <div class="tab4"><span>[Last Name]</span></div>
                    </td>
                    <td width="20%" align="center" valign="center">
                      <div class="tab4"><span>[Subscription Name]</span></div>
                    </td>
                    <td width="20%" align="center" valign="center">
                      <div class="tab4"><span>$[x,xxx,xx]</span></div>
                    </td>
                    <td width="20%" align="center" valign="center">
                      <div class="tab4"><span>[Payment Date]</span></div>
                    </td>
                  </tr>
                </tbody> -->
                <tbody>
                    @foreach ($transactions as $transaction)
                        <tr style="padding: 0 10px">
                            <td width="20%" align="center" valign="center">
                                <div class="tab4"> 
                                  <span>{{ $transaction->f_name }}</span>
                                </div>
                            </td>
                            <td width="20%" align="center" valign="center">
                                <div class="tab4"> 
                                  <span>{{ $transaction->l_name }}</span>
                              </div>
                            </td>
                            <td width="20%" align="center" valign="center">
                                <div class="tab4"> 
                            ...
                            <td width="20%" align="center" valign="center">
                                <div class="tab4"> <span>
                                {{ \Carbon\Carbon::parse($transaction->created_at)->format('M d, Y') }}</span></div>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
